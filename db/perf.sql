...
--    여기서는 '(주)·주식회사·㈜' 만 떼고 묶습니다. 그 이상은 임의로
--    합치지 않습니다.
--
--  🚨 【2026-08-12 — 표기를 모으는 일은 여기가 아니라 매칭에서 합니다】
--    대표님 지적: "웰컴에 보이는 출판사와 저자 순위가 계속 꼬여있다."
--    'YBM(와이비엠) / YBM / 와이비엠' 이 세 줄로 쪼개져 점수까지
--    나뉘고 있었습니다. SQL 로는 '글자가 똑같은가' 밖에 못 봐서
--    여기서는 풀 수 없습니다.
--    그래서 매칭(crawler/common/names.py)이 도서 마스터를 만들 때
--    **온 자료를 통틀어 정한 이름 하나**를 넣습니다. 이 함수는 그
--    이름을 그대로 셉니다. 이 파일은 고칠 필요가 없습니다.
-- ----------------------------------------------------------------------------
